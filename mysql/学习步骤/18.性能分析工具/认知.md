...
## **19.1** **统计SQL的查询成本：last_query_cost**
...
### **19.2.3** **慢查询日志分析工具：mysqldumpslow**
...
## **19.7 MySQL监控分析视图-sys schema** 

### **19.7.1 Sys schema视图使用场景**
